...
public final class Constants {
  public static final class DriveConstants {
    ...
    public static final int[] kRearRightEncoderPorts = new int[] {2, 3};
    ...
    public static final double kTrackWidth = 0.413;
    // Distance between centers of right and left wheels on robot
    public static final double kWheelBase = 0.336;
    ...
    public static final double kEncoderCPR = 537.7 / 4;
    public static final double kWheelDiameterMeters = 0.104;
